    ...
    <body>
        ...
        <table width="60%" align="center" cellpadding="5" border="0">
            ...
            <tr class="shade">
                ...
                <td width="50%"><input type="text" name="version" value="76" size="8" maxlength="80" /></td>
            </tr>
            ...
            <tr class="shade">
                 <td align="right" width="50%"><strong>transaction</strong></td>
            ...
            <tr>
                ...
                <td><input type="text" name="sourceOfFunds[provided][card][number]" value="5123456789012346" size="19" maxlength="80"/></td>
            </tr>

            <tr class="shade">
                <td align="right"><strong>sourceOfFunds.provided.card.expiry.month </strong></td>
                <td><input type="text" name="sourceOfFunds[provided][card][expiry][month]" value="01" size="1" maxlength="2"/></td>
            </tr>

            <tr>
                <td align="right"><strong>sourceOfFunds.provided.card.expiry.year </strong></td>
                <td><input type="text" name="sourceOfFunds[provided][card][expiry][year]" value="39" size="1" maxlength="2"/></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="order[amount]" value="10" size="8" maxlength="13"/></td>
            </tr>

            <tr class="shade">
                <td align="right"><strong>order.currency </strong></td>
                <td><input type="text" name="order[currency]" value="USD" size="8" maxlength="3"/></td>
            </tr>
            <tr>
                <td colspan="2"><center><input type="submit" name="submit" value="Process Authorization"/></center></td>
            </tr>
